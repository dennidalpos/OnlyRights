...
namespace NtfsAudit.App.Tests
{
    public class MainViewModelDisplayStateTests
    {
        ...
        {
            LocalizationManager.Apply(new ResourceDictionary(), "en");
            MainViewModel.ServiceInstalledQueryHook = _ => false;
            MainViewModel.ServiceRunningQueryHook = _ => false;
            try
            {
                var viewModel = new MainViewModel();
                viewModel.ScanRoots.Add(@"C:\Data");
                ...
                MainViewModel.ServiceInstalledQueryHook = _ => true;
                typeof(MainViewModel)
            ...
            {
                MainViewModel.ServiceInstalledQueryHook = null;
                MainViewModel.ServiceRunningQueryHook = null;
            }
        }
